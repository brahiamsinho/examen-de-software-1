...
- **Newest work (2026-09-20, small direct change, uncommitted):** "Descargar backend" button + `apps.generation_export` (`GET /api/orgs/{org_slug}/documents/{doc_id}/generate` returns the deterministic Spring Boot zip of a stored document; backend 1285 passed, frontend 363 passed; details in `CURRENT_STATE.md`).
